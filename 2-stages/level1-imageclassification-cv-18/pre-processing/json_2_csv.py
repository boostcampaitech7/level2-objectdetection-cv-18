...
# train.json 파일 경로 설정
json_file_path = '/hdd1/lim_data/level2_dataset/val_split_4.json'

# 잘라낸 이미지를 저장할 폴더 경로 설정
output_folder = '/hdd1/lim_data/level2_dataset/crop_train'

# 학습 데이터를 저장할 CSV 파일 경로 설정
csv_file_path = '/hdd1/lim_data/level2_dataset/csv/val_4.csv'
...
with open(csv_file_path, 'w', newline='') as csvfile:
    ...
    for annotation in data['annotations']:
        ...
        cropped_image_file_name = f"{image_id}_{category_id}_cropped.jpg"
        cropped_image_path = os.path.join(output_folder, cropped_image_file_name)
        relative_image_path = os.path.join('crop_train', cropped_image_file_name)
