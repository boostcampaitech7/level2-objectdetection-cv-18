...
def main():
    ...
    """
    # Config 파일 로드 및 수정
    cfg = Config.fromfile('/data/ephemeral/home/jeonga/level2-objectdetection-cv-18/Co-DETR/configs/faster_rcnn/faster_rcnn_r50_caffe_fpn_1x_coco.py')  # 모델 설정
    cfg.work_dir = './work_dirs/faster_rcnn_r50_caffe_fpn_1x_coco'                      # 로그/모델 저장 위치
    ...
    cfg.data.train.ann_file = root + 'train_0.json'
    cfg.data.val.classes = classes
    cfg.data.val.img_prefix = root
    cfg.data.val.ann_file = root + 'val_0.json'
