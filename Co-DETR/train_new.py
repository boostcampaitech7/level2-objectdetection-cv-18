...
def main():
    ...
    """
    # Config 파일 로드 및 수정
    cfg = Config.fromfile('./projects/configs/co_dino/co_dino_5scale_lsj_swin_large_1x_coco_SR.py')  # 모델 설정
    cfg.work_dir = './work_dirs/co_dino_5scale_lsj_swin_large_SR'                      # 로그/모델 저장 위치
