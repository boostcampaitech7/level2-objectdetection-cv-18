...
annotation_path = '/data/ephemeral/home/taehan/level2-objectdetection-cv-18/EDSR-PyTorch/experiment/test/train_0_sr_x2.json'
original_anno_path = '/data/ephemeral/home/dataset/train_0.json'

# saved path
subimgs_path = '/data/ephemeral/home/sr_dataset/centerimages'
updated_annotation_path = '/data/ephemeral/home/sr_dataset/train_0_x2_SR_center.json'
...
# 새로운 데이터를 기반으로 새로운 json 파일 저장
new_data = {
    'images': new_images,
    'annotations': new_annotations,
    'categories': data['categories'],  # 기존의 categories 정보는 유지
}
